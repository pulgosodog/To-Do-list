...
"To-do list" is a tool that helps to organize your day. It simply lists the things that you need to do and allows you to mark them as complete using ES6 and Webpack!
...
npm dependencies are required, on the CLI run ```npm install``` command to install the dependencies.

### Usage

To run the project, on the CLI run ```npm start``` command to open the Webpack dev server.
